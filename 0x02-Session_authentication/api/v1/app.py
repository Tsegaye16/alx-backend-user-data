...
def filter():
    """
    checking weather an auth is enabled or not
    """
    if auth is None:
        return
    path = request.path
...
def not_authorized(error) -> str:
    """
    user not authorized handler method
    """
...
def forbidden(error) -> str:
    """
    action forbidden handler method
    """
